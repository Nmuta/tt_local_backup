...
import { DataPipelineGuard } from './data-pipeline.guard';

describe('DataPipelineGuard:', () => {
  let guard: DataPipelineGuard;
  let store: Store;
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(DataPipelineGuard);
  ...
  describe('When profile has a valid role: ', () => {
    ...
    describe('DataPipelineContributor', () => {
      beforeEach(() => {
        testProfile.role = UserRole.DataPipelineContributor;
        guard.profile$ = of(testProfile);
      });
    ...
    describe('DataPipelineRead', () => {
      beforeEach(() => {
        testProfile.role = UserRole.DataPipelineRead;
        guard.profile$ = of(testProfile);
      });
    ...
    describe('SupportAgent', () => {
      ...
      it('should call router.navigate correctly', fakeAsync(() => {
        ...
        expect(store.dispatch).toHaveBeenCalledWith(
          new Navigate(['/unauthorized'], { app: 'Data Pipeline' }),
        );
      }));
    });
  });
