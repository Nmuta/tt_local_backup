...
import { LiveOpsGuard } from './live-ops.guard';

describe('LiveOpsGuard:', () => {
  let guard: LiveOpsGuard;
  let store: Store;
  ...
  beforeEach(() => {
    ...
    guard = TestBed.inject(LiveOpsGuard);
    ...
    describe('DataPipelineAdmin', () => {
      ...
      it('should call router.navigate correctly', fakeAsync(() => {
        ...
        expect(store.dispatch).toHaveBeenCalledWith(
          new Navigate(['/unauthorized'], { app: 'Live Ops' }),
        );
      }));
    });
  });
