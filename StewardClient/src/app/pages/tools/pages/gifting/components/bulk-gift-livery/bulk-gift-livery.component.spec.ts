...
describe('BulkGiftLiveryComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    component.service = {
      ...
      getLivery$(liveryId: string): Observable<PlayerUgcItem> {
        return mockWoodstockService.getPlayerUgcItem$(liveryId, UgcType.Livery);
      },
      ...
      giftLiveriesToPlayers$(
        ...
        _titleMessageId: GuidLikeString,
        _bodyMessageId: GuidLikeString,
        ...
        return mockPlayerGiftService.giftLiveriesByXuids$(
          giftReason,
          liveryIds,
          xuids,
          expireAfterDays,
      ...
      giftLiveriesToLspGroup$(
        ...
        return mockGroupGiftService.giftLiveriesByUserGroup$(
          giftReason,
          liveryIds,
          lspGroup.id,
          expireAfterDays,
  ...
  describe('Method: getLivery$', () => {
    ...
    it('should call WoodstockService.getPlayerUgcItem$ with correct parmas', () => {
  ...
  describe('Method: giftLiveriesToPlayers$', () => {
    ...
    const bodyId = faker.datatype.uuid();
    ...
    describe('If xuid list provided is null', () => {
      it('should throw error', () => {
        component.service
          .giftLiveriesToPlayers$(liveryIds, null, giftReason, expireAfterDays, titleId, bodyId)
          .pipe(
            take(1),
            catchError(_error => {
    ...
    describe('If xuid list provided length is 0', () => {
      it('should throw error', () => {
        component.service
          .giftLiveriesToPlayers$(liveryIds, [], giftReason, expireAfterDays, titleId, bodyId)
          .pipe(
            take(1),
            catchError(_error => {
              expect(true).toBeTruthy();
  ...
  describe('Method: giftLiveriesToLspGroup$', () => {
    ...
    describe('If lsp group provided is null', () => {
      it('should throw error', () => {
        component.service
          .giftLiveriesToLspGroup$(liveryIds, null, giftReason, expireAfterDays, titleId, bodyId)
          .pipe(
            take(1),
            catchError(_error => {
              expect(true).toBeTruthy();
