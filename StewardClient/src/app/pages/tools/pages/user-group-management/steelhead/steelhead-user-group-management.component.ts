...
/** The Steelhead user group management tool. */
@Component({
  templateUrl: './steelhead-user-group-management.component.html',
  styleUrls: ['./steelhead-user-group-management.component.scss'],
})
export class SteelheadUserGroupManagementComponent extends BaseComponent implements OnInit {
  ...
  public newUserGroupCreated(userGroup: LspGroup) {
    this.store
      .dispatch(new GetLspGroups(GameTitleCodeName.FM8, true))
      .pipe(takeUntil(this.onDestroy$))
      .subscribe(() => {
