...
describe('PlayerSelectionSingleComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [createMockSunriseService(), createMockGravityService(), createMockApolloService(), createMockOpusService()],
    ...
    sunrise.getPlayerIdentities = jasmine
      ...
      .and.callFake(q => deferUntil.pipe(switchMap(_ => of(SunrisePlayersIdentitiesFakeApi.make(q)))));
    ...
    gravity.getPlayerIdentities = jasmine
      .createSpy('getPlayerIdentities')
      .and.callFake(q => deferUntil.pipe(switchMap(_ => of(GravityPlayersIdentitiesFakeApi.make(q)))));

    apollo.getPlayerIdentities = jasmine
      .createSpy('getPlayerIdentities')
      .and.callFake(q => deferUntil.pipe(switchMap(_ => of(ApolloPlayersIdentitiesFakeApi.make(q)))));
  });
