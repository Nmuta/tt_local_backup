 ...
 */
@Component({
  selector: 'notification-management-base',
  templateUrl: './notification-management.base.component.html',
  styleUrls: ['./notification-management.base.component.scss'],
})
export class NotificationManagementBaseComponent
  extends BaseComponent
  implements OnInit, AfterViewInit {
  @Input() service: NotificationManagementService;
  ...
  public retrieveNotifications(): void {
