...
describe('UtcInterceptor', () => {
  ...
  const testResponseArray: TestResponseArray = [testResponseSimple, testResponseSimple, testResponseSimple];
  ...
  const testResponseCompositeArray: TestResponseCompositeArray = [testResponseComposite, testResponseComposite, testResponseComposite];
