...
export class SteelheadGroupXuidsInventoryFakeApi extends FakeApiBase {
  ...
  public get canHandle(): boolean {
    ...
    const regex = /^\/?api\/v1\/title\/steelhead\/group\/xuids\/inventory$/i;
    return regex.test(url.pathname);
  }

  /** Produces a sample API response. */
  public handle(): SteelheadPlayerInventory {
    return SteelheadGroupXuidsInventoryFakeApi.make();
  }
