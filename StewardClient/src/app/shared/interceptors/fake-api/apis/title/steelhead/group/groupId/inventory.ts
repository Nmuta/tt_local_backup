...
export class SteelheadGroupGroupIdInventoryFakeApi extends FakeApiBase {
  ...
  public get canHandle(): boolean {
    ...
    const regex = /^\/?api\/v1\/title\/steelhead\/group\/groupId\((.+)\)\/inventory$/i;
    return regex.test(url.pathname);
  }

  /** Produces a sample API response. */
  public handle(): SteelheadPlayerInventory {
    return SteelheadGroupGroupIdInventoryFakeApi.make();
  }
