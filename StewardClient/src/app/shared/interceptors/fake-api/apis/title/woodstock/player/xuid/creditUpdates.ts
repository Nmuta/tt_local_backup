...
export class WoodstockPlayerXuidCreditUpdatesFakeApi extends FakeApiBase {
  ...
  public get canHandle(): boolean {
    ...
    const regex = /^\/?api\/v1\/title\/woodstock\/player\/xuid\((\d+)\)\/creditUpdates$/i;
    return regex.test(url.pathname);
  }

  /** Produces a sample API response. */
  public handle(): WoodstockCreditDetailsEntry[] {
    return WoodstockPlayerXuidCreditUpdatesFakeApi.makeMany();
  }
