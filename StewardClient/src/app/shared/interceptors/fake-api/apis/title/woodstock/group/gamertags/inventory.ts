...
export class WoodstockGroupGamertagsInventoryFakeApi extends FakeApiBase {
  ...
  public get canHandle(): boolean {
    ...
    const regex = /^\/?api\/v1\/title\/woodstock\/group\/gamertags\/inventory$/i;
    return regex.test(url.pathname);
  }

  /** Produces a sample API response. */
  public handle(): WoodstockPlayerInventory {
    return WoodstockGroupGamertagsInventoryFakeApi.make();
  }
