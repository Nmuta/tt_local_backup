...
export class ApolloPlayersIdentitiesFakeApi extends FakeApiBase {
  ...
  public get canHandle(): boolean {
    ...
    const regex = /^\/?api\/v1\/title\/apollo\/players\/identities$/i;
    return regex.test(url.pathname);
  }

  /** Produces a sample API response. */
  public handle(body?: unknown): IdentityResultAlpha[] {
    return ApolloPlayersIdentitiesFakeApi.make(body as IdentityQueryAlpha[]);
  }
