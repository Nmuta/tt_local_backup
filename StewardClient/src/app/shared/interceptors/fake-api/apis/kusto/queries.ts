...
import { AllKustoQueries } from '@models/kusto';
...
export class KustoGetQueriesFakeApi extends FakeApiBase {
  ...
  public handle(): Partial<Unprocessed<AllKustoQueries>> {
    return KustoGetQueriesFakeApi.make();
  }

  /** Generates a sample object */
  public static make(): Partial<Unprocessed<AllKustoQueries>> {
    return {
      gravity: [
        {
          name: 'Lorem Ipsum',
        ...
        { name: 'Test Query 5', query: 'Test Query 5' },
      ],
      sunrise: [
        { name: 'Test Query 1', query: 'Test Query 1' },
        { name: 'Test Query 2', query: 'Test Query 2' },
        { name: 'Test Query 3', query: 'Test Query 3' },
        { name: 'Test Query 6', query: 'Test Query 6' },
      ],
      apollo: [
        { name: 'Test Query 9', query: 'Test Query 9' },
        { name: 'Test Query 10', query: 'Test Query 10' },
      ],
      opus: [
        { name: 'Test Query 7', query: 'Test Query 7' },
        { name: 'Test Query 8', query: 'Test Query 8' },
      ],
    };
  }
}
