...
export class MockSunriseService {
  public getPlayerDetailsByGamertag = jasmine.createSpy("getPlayerDetailsByGamertag").and.returnValue(of());
  ...
  public getSharedConsoleUsersByXuid = jasmine.createSpy("getSharedConsoleUsersByXuid").and.returnValue(of());
  public getConsoleDetailsByXuid = jasmine.createSpy("getConsoleDetailsByXuid").and.returnValue(of());
  public putBanStatusByConsoleId = jasmine.createSpy("putBanStatusByConsoleId").and.returnValue(of());
  public getProfileSummaryByXuid = jasmine.createSpy("getProfileSummaryByXuid").and.returnValue(of());
