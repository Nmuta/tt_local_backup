...
/** The /v2/title/steelhead/servicesTableStorage. */
@Injectable({
  providedIn: 'root',
})
export class SteelheadServicesTableStorageService {
  public readonly basePath: string = 'title/steelhead/servicesTableStorage';
