...
export class MockTicketService {
  ...
  public getTicketRequestorGamertag$ = jasmine.createSpy('getTicketRequestorGamertag$').and.returnValue(defer(() => of(this.activeGamertag)));
  public getForzaTitle$ = jasmine.createSpy('getForzaTitle$').and.returnValue(defer(() => of(this.activeTitle)));
}
