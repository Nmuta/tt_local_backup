...
namespace Turn10.LiveOps.StewardTest.Integration.Woodstock
{
    public sealed class WoodstockStewardTestingClient
    {
        ...
        public async Task<WoodstockPlayerDetails> GetPlayerDetailsAsync(string gamertag)
        {
            ...
            return await ServiceClient.SendRequestAsync<WoodstockPlayerDetails>(HttpMethod.Get, path, this.authKey, Version).ConfigureAwait(false);
        }
        ...
        public async Task<WoodstockUserFlags> GetUserFlagsAsync(ulong xuid)
        {
            ...
            return await ServiceClient.SendRequestAsync<WoodstockUserFlags>(HttpMethod.Get, path, this.authKey, Version).ConfigureAwait(false);
        }
        ...
        public async Task<WoodstockUserFlags> SetUserFlagsAsync(ulong xuid, WoodstockUserFlagsInput userFlags)
        {
            ...
            return await ServiceClient.SendRequestAsync<WoodstockUserFlags>(HttpMethod.Put, path, this.authKey, Version, userFlags).ConfigureAwait(false);
        }
        ...
        public async Task<WoodstockMasterInventory> GetPlayerInventoryAsync(ulong xuid)
        {
            ...
            return await ServiceClient.SendRequestAsync<WoodstockMasterInventory>(HttpMethod.Get, path, this.authKey, Version).ConfigureAwait(false);
        }
        ...
        public async Task<IList<WoodstockInventoryProfile>> GetInventoryProfilesAsync(ulong xuid)
        {
            ...
            return await ServiceClient.SendRequestAsync<IList<WoodstockInventoryProfile>>(HttpMethod.Get, path, this.authKey, Version).ConfigureAwait(false);
        }
        ...
        public async Task<IList<WoodstockGiftHistory>> GetGiftHistoriesAsync(ulong xuid)
        {
            ...
            return await ServiceClient.SendRequestAsync<IList<WoodstockGiftHistory>>(HttpMethod.Get, path, this.authKey, Version).ConfigureAwait(false);
        }
        ...
        public async Task<IList<Notification>> GetNotificationsAsync(ulong xuid, int maxResults)
        {
            ...
            return await ServiceClient.SendRequestAsync<IList<Notification>>(HttpMethod.Get, path, this.authKey, Version).ConfigureAwait(false);
        }
