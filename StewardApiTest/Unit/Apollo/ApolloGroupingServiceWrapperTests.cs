...
{
    [TestClass]
    public sealed class ApolloGroupingServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public ApolloGroupingServiceWrapper Build() => new ApolloGroupingServiceWrapper(this.Configuration, this.KeyVaultProvider);
        }
    }
}
