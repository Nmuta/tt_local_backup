...
{
    [TestClass]
    public sealed class ApolloGiftingServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public ApolloGiftingServiceWrapper Build() => new ApolloGiftingServiceWrapper(this.Configuration, this.KeyVaultProvider);
        }
    }
}
