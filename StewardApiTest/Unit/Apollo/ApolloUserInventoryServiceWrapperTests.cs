...
{
    [TestClass]
    public sealed class ApolloUserInventoryServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public ApolloUserInventoryServiceWrapper Build() => new ApolloUserInventoryServiceWrapper(this.Configuration, this.KeyVaultProvider);
        }
    }
}
