...
{
    [TestClass]
    public sealed class SunriseUserInventoryServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public SunriseUserInventoryServiceWrapper Build() => new SunriseUserInventoryServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
