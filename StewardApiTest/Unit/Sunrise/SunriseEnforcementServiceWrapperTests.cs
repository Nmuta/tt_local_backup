...
{
    [TestClass]
    public sealed class SunriseEnforcementServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public SunriseEnforcementServiceWrapper Build() => new SunriseEnforcementServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
