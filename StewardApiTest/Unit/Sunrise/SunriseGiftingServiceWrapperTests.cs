...
{
    [TestClass]
    public sealed class SunriseGiftingServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public SunriseGiftingServiceWrapper Build() => new SunriseGiftingServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
