...
{
    [TestClass]
    public sealed class SunriseUserServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public SunriseUserServiceWrapper Build() => new SunriseUserServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
