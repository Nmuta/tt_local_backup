...
{
    [TestClass]
    public sealed class SunriseNotificationsServiceTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public SunriseNotificationsServiceWrapper Build() => new SunriseNotificationsServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
