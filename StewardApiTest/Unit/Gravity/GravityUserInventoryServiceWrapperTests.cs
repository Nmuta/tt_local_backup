...
{
    [TestClass]
    public sealed class GravityUserInventoryServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            public Dependencies(bool validConfiguration = true)
            {
                ...
                if (validConfiguration)
                {
                    ...
                    this.Configuration["GravityEnvironment:AdminXuid"].Returns("1234567890");
                    this.Configuration["GravityEnvironment:TitleId"].Returns("1234567890");
                }
                else
                {
            ...
            public GravityUserInventoryServiceWrapper Build() => new GravityUserInventoryServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
