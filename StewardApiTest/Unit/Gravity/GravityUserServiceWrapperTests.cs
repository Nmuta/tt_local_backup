...
{
    [TestClass]
    public sealed class GravityUserServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public GravityUserServiceWrapper Build() => new GravityUserServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
