...
{
    [TestClass]
    public sealed class GravityGameSettingsServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public GravityGameSettingsServiceWrapper Build() => new GravityGameSettingsServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
