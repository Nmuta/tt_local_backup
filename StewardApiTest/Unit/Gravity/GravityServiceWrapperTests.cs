...
{
    [TestClass]
    public sealed class GravityServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public GravityServiceWrapper Build() => new GravityServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
