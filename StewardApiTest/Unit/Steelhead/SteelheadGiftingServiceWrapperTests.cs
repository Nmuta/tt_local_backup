...
{
    [TestClass]
    public sealed class SteelheadGiftingServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public SteelheadGiftingServiceWrapper Build() => new SteelheadGiftingServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
