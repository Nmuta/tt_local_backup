...
{
    [TestClass]
    public sealed class SteelheadUserServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public SteelheadUserServiceWrapper Build() => new SteelheadUserServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
