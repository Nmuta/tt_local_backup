...
{
    [TestClass]
    public sealed class SteelheadUserInventoryServiceWrapperTests
    {
        ...
        private sealed class Dependencies
        {
            ...
            public SteelheadUserInventoryServiceWrapper Build() => new SteelheadUserInventoryServiceWrapper(this.Configuration, this.KeyVaultProvider, this.RefreshableCacheStore, this.StsClient);
        }
    }
}
