...
{
    [TestClass]
    public sealed class WoodstockGiftHistoryProviderTests
    {
        ...
        public void UpdateGiftHistoryAsync_WithValidParameters_DoesNotThrow()
        {
            ...
            var giftInventory = Fixture.Create<WoodstockGift>();
        ...
        public async Task GetGiftHistoryAsync_WithValidParameters_ReturnsCorrectType()
        {
            ...
            // Act.
            async Task<IList<WoodstockGiftHistory>> Action() => await provider.GetGiftHistoriesAsync(id, title, antecedent, endpoint, startDate, endDate).ConfigureAwait(false);
        ...
        private sealed class Dependencies
        {
            ...
            public WoodstockGiftHistoryProvider Build() => new WoodstockGiftHistoryProvider(this.KustoStreamingLogger, this.KustoProvider, this.Configuration);
        }
    }
}
