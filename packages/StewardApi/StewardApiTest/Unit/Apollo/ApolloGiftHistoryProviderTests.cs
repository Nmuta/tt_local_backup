...
namespace Turn10.LiveOps.StewardTest.Unit.Apollo
{
    ...
    public sealed class ApolloGiftHistoryProviderTests
    {
        ...
        public async Task GetGiftHistoryAsync_WithValidParameters_ReturnsCorrectType()
        {
            ...
            // Act.
            async Task<IList<ApolloGiftHistory>> Action() => await provider.GetGiftHistoriesAsync(id, title, antecedent, endpoint, startDate, endDate).ConfigureAwait(false);
        ...
        private sealed class Dependencies
        {
            ...
            public ApolloGiftHistoryProvider Build() => new ApolloGiftHistoryProvider(this.KustoStreamingLogger, this.KustoProvider, this.Configuration);
        }
    }
}
