...
namespace Turn10.LiveOps.StewardApi.Providers.Steelhead.ServiceConnections
{
    ...
    public interface ISteelheadPegasusService
    {
        ...
        ///     Gets tracks.
        /// </summary>
        Task<IEnumerable<Track>> GetTracksAsync(string pegasusEnvironment, string slotId = SteelheadPegasusSlot.Daily);
        ...
        /// </summary>
        Task<IEnumerable<LiveOpsContracts.DivisionFeaturedShowcase>> GetDivisionFeaturedShowcasesAsync();

        /// <summary>
        ///     Gets Manufacturer Featured Showcases.
        /// </summary>
        Task<IEnumerable<LiveOpsContracts.ManufacturerFeaturedShowcase>> GetManufacturerFeaturedShowcasesAsync();
        ...
        /// </summary>
        Task<Dictionary<Guid, string>> GetDateTimeRangesAsync();

        /// <summary>
        ///     Gets Challenges.
        /// </summary>
        Task<Dictionary<Guid, string>> GetChallengesAsync();

        /// <summary>
        ///     Gets Featured Showcases.
        /// </summary>
        Task<Dictionary<Guid, string>> GetFeaturedShowcasesAsync();
    }
}
