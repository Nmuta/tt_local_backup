...
{
    /// <summary>
    ///     Controller for Woodstock Ugc visibility.
    /// </summary>
    [Route("api/v{version:apiVersion}/title/woodstock/ugc/visibility")]
    [LogTagTitle(TitleLogTags.Woodstock)]
    [ApiController]
    [ApiVersion("2.0")]
    [Tags(Title.Woodstock, Topic.Ugc, Target.Details)]
    public class VisibilityController : V2WoodstockControllerBase
    {
        ...
        private async Task<CreatedResult> SetUgcVisibilityStatusUseBackgroundProcessing(Guid[] ugcIds, bool shouldBeHidden)
        {
            ...
            var jobId = await this.jobTracker.CreateNewJobAsync(ugcIds.ToJson(), requesterObjectId, $"Woodstock Update Visibility Multiple Ugc.", this.Response);
