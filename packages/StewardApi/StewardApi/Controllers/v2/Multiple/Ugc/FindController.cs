...
namespace Turn10.LiveOps.StewardApi.Controllers.V2.Multiple.Ugc
{
    ...
    public class FindController : V2ControllerBase
    {
        ...
        private readonly IList<FH5UGCContentType> fh5SupportedTypes = new List<FH5UGCContentType> { FH5UGCContentType.Livery, FH5UGCContentType.Layergroup, FH5UGCContentType.Tune, FH5UGCContentType.Photo, FH5UGCContentType.EventBlueprint, FH5UGCContentType.CommunityChallenge, FH5UGCContentType.PropPrefab };
        private readonly IList<FM8UGCContentType> fm8SupportedTypes = new List<FM8UGCContentType> { FM8UGCContentType.Livery, FM8UGCContentType.TuneBlob, FM8UGCContentType.Photo, FM8UGCContentType.Layergroup, FM8UGCContentType.GameOptions, FM8UGCContentType.Replay };
