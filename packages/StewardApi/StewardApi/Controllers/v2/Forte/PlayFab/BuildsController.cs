...
namespace Turn10.LiveOps.StewardApi.Controllers.v2.Forte.PlayFab
{
    /// <summary>
    ///     Handles requests for Forte PlayFab build integrations.
    /// </summary>
    [Route("api/v{version:apiVersion}/title/forte/playfab/builds")]
    [AuthorizeRoles(UserRole.LiveOpsAdmin, UserRole.GeneralUser)]
    [LogTagTitle(TitleLogTags.Forte)]
    [ApiController]
    [ApiVersion("2.0")]
    [StandardTags(Title.Forte)]
    public class BuildsController : V2ForteControllerBase
    {
        ...
        /// </summary>
        public BuildsController(IFortePlayFabService playFabService, IPlayFabBuildLocksProvider playFabBuildLocksProvider, IBlobStorageProvider blobStorageProvider)
        {
