...
{
    /// <summary>
    ///     Validates a <see cref="SteelheadGroupGift"/> request.
    /// </summary>
    public sealed class SteelheadGroupGiftRequestValidator : RequestValidatorBase, IRequestValidator<SteelheadGroupGift>
    {
        private readonly IRequestValidator<SteelheadMasterInventory> masterInventoryRequestValidator;

        /// <summary>
        ///     Initializes a new instance of the <see cref="SteelheadGroupGiftRequestValidator"/> class.
        /// </summary>
        public SteelheadGroupGiftRequestValidator(IRequestValidator<SteelheadMasterInventory> masterInventoryRequestValidator)
        {
        ...
        /// <inheritdoc />
        public void Validate(SteelheadGroupGift model, ModelStateDictionary modelState)
        {
        ...
        /// <inheritdoc />
        public void ValidateIds(SteelheadGroupGift model, ModelStateDictionary modelState)
        {
            model.ShouldNotBeNull(nameof(model));
            modelState.ShouldNotBeNull(nameof(modelState));
