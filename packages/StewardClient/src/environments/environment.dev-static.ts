...
export const environment: StewardEnvironment = {
  ...
  stewardUiUrl: 'https://gentle-cliff-004fcc01e.3.azurestaticapps.net',
  stewardApiUrl: 'https://gentle-cliff-004fcc01e.3.azurestaticapps.net',
  stewardUiStagingUrl: 'https://steward-ui-dev-staging.azurewebsites.net',
  stewardApiStagingUrl: 'https://steward-api-dev-staging.azurewebsites.net',
