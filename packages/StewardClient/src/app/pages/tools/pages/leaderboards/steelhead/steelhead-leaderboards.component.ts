...
/** The Steelhead leaderboards page. */
@Component({
  templateUrl: './steelhead-leaderboards.component.html',
  styleUrls: ['./steelhead-leaderboards.component.scss'],
})
export class SteelheadLeaderboardsComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    private readonly steelheadLeaderboardsService: SteelheadLeaderboardsService,
    ...
    this.route.queryParams
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.steelheadLeaderboardsService
  ...
  private hasValidDeviceTypes(query: LeaderboardQuery): boolean {
    ...
    if (hasInvalidDevices) {
      query.deviceTypes = validDeviceTypes?.join(',') ?? undefined;
      this.router.navigate([], {
        queryParams: query,
        replaceUrl: true,
      });
