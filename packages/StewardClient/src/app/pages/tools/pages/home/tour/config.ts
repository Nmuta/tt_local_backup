...
export const tourSteps: IStepOption[] = [{
  ...
  content: 'Be sure to read through the <b>Active Changelog</b> and check the boxes so you can stay up to date on new changes!',
  enableBackdrop: true,
}, {
  anchorId: 'home-tour.step.four',
  content: 'Each tile represents a <b>tool</b> that is available for you to use.<br /><br />The number of available tools may differ depending on the permissions associated with your account.',
  enableBackdrop: true,
  disablePageScrolling: true,
  disableScrollToAnchor: true,
}, {
  anchorId: 'home-tour.step.five',
  content: 'Using the <b>In Nav</b> checkbox on the tool tile adds or removes the tool from the nav bar.',
  enableBackdrop: true,
}, {
  anchorId: 'home-tour.step.six',
  content: 'The order of the tools in the nav bar can be rearranged if you click on the <b>Edit</b> icon.',
  enableBackdrop: true,
}, {
  anchorId: 'home-tour.step.seven',
  content: 'While in <b>Edit Mode</b>, all the links to the tools on the nav bar appear as buttons, so you can drag and drop them in the order you prefer.',
  enableBackdrop: true,
}, {
  anchorId: 'home-tour.step.eight',
  content: 'Use our <b>Contact Us</b> form if you need help, want to report a bug, or have a suggestion for a new feature.',
  enableBackdrop: true,
}, {
