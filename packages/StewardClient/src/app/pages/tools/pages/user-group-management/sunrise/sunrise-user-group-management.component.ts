...
/** The Sunrise user group management tool. */
@Component({
  templateUrl: './sunrise-user-group-management.component.html',
  styleUrls: ['./sunrise-user-group-management.component.scss'],
})
export class SunriseUserGroupManagementComponent extends BaseComponent implements OnInit {
  ...
  public newUserGroupCreated(userGroup: LspGroup) {
    this.store
      .dispatch(new GetLspGroups(GameTitleCodeName.FH4, true))
      .pipe(takeUntil(this.onDestroy$))
      .subscribe(() => {
