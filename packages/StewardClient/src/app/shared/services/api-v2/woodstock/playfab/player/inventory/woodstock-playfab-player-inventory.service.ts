...
import { PlayFabInventoryItem, PlayFabTransaction, PlayFabInventoryChangeRequest, PlayFabCollectionId } from '@models/playfab';
...
export class WoodstockPlayFabPlayerInventoryService {
  ...
  public getCurrencyInventory$(playfabTitleEntityId: string, collectionId: PlayFabCollectionId): Observable<PlayFabInventoryItem[]> {
  ...
  public getTransactionHistory$(playfabTitleEntityId: string, collectionId: PlayFabCollectionId): Observable<PlayFabTransaction[]> {
  ...
  public addItem$(
    ...
    return this.api.postRequest$<void>(`${this.basePath}/${playfabTitleEntityId}/inventory/${collectionId}/add`, {
      itemId: itemId,
      amount: amountToAdd,
