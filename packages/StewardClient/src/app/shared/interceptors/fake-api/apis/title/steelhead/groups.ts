...
/** Fake API for finding steelhead groups. */
export class SteelheadGroupsFakeApi extends FakeApiBase {
  ...
  public get canHandle(): boolean {
    ...
    const regex = /^\/?api\/v1\/title\/steelhead\/groups$/i;
    return regex.test(url.pathname);
  }

  /** Produces a sample API response. */
  public handle(): LspGroups {
    return SteelheadGroupsFakeApi.make();
  }
