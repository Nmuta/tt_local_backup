...
export class WoodstockCarsCacheService {
  private lookup = new Map<string, SimpleCar>();
  ...
  public getDetails(carId: string | BigNumber): SimpleCar | null {
  ...
  public getDetails$(carId: string | BigNumber): Observable<SimpleCar> {
  ...
  public updateLookup(): void {
    ...
    this.woodstock
      .getSimpleCars$(PegasusProjectionSlot.LiveSteward)
  ...
  private produceLookups(cars: SimpleCar[]): void {
