namespace Tests.Scrutineer
{
    ...
    {
        public const string ArgumentOutOfRangeExceptionMessagePartial = "Specified argument was out of the range of valid values.\r\nParameter name: {0} must be > {1}. {0} was {2}.";
        ...
        public const string InvalidApiKey = "ApiKeyAuth ThisIsNotAnApiKeyAtAll";
        public const ulong InvalidXuid = 9223372036854775807;
