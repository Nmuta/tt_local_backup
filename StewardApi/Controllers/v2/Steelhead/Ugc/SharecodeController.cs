...
namespace Turn10.LiveOps.StewardApi.Controllers.V2.Steelhead.Ugc
{
    ...
    /// </summary>
    [Route("api/v{version:apiVersion}/title/steelhead/ugc/sharecode")]
    ...
    public class SharecodeController : V2SteelheadControllerBase
    {
        ...
        {
            var storefrontManagementService = this.SteelheadServices.Value.StorefrontManagementService;
        ...
        private async Task<CreatedResult> GenerateSharecodeUsingBackgroundProcessing(IStorefrontManagementService storefrontManagementService, Guid[] ugcIds)
        {
            ...
            var jobId = await this.jobTracker.CreateNewJobAsync(ugcIds.ToJson(), requesterObjectId, $"Steelhead Generate Multiple Sharecodes.", this.Response).ConfigureAwait(true);
