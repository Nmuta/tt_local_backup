...
namespace Turn10.LiveOps.StewardApi.Controllers.V2.Woodstock.Player
{
    ...
    public sealed class CreditUpdatesController : V2WoodstockControllerBase
    {
        ...
        private const string KustoDatabase = "Prod Woodstock Telemetry";
            ...
            [FromQuery] int maxResults = DefaultMaxResults)
        {
            ...
            var result = await this.kustoProvider.GetCreditUpdatesAsync(xuid, KustoDatabase, sortEnum, columnEnum, startIndex, maxResults).ConfigureAwait(true);
