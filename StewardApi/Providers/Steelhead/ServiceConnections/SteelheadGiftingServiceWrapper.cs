...
{
    /// <inheritdoc />
    public sealed class SteelheadGiftingServiceWrapper : ISteelheadGiftingService
    {
        ...
        /// <summary>
        ///      Initializes a new instance of the <see cref="SteelheadGiftingServiceWrapper"/> class.
        /// </summary>
        public SteelheadGiftingServiceWrapper(IConfiguration configuration, IKeyVaultProvider keyVaultProvider, IRefreshableCacheStore refreshableCacheStore, IStsClient stsClient)
        {
