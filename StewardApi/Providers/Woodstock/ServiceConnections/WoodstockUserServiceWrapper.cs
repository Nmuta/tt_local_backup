...
{
    /// <inheritdoc />
    public sealed class WoodstockUserServiceWrapper : IWoodstockUserService
    {
        ...
        /// <summary>
        ///      Initializes a new instance of the <see cref="WoodstockUserServiceWrapper"/> class.
        /// </summary>
        public WoodstockUserServiceWrapper(IConfiguration configuration, IKeyVaultProvider keyVaultProvider, IRefreshableCacheStore refreshableCacheStore, IStsClient stsClient)
        {
